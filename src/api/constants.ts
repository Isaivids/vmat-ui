...
export const getVMAT = () => {
  return [
    ...
    { field: "ats.trucknumber", header: "Truck Number" },
    { field: "ats.transname", header: "Transport Name" },
    { field: "ats.truckf", header: "Truck Freight" },
...
export const vmatWidths = [70,'*',100,50,50,50,50,50,50,50,50,50,50,50,70,50]
...
export const getTBP = () => {
  return [
    ...
    { field: "extlabourwagesfromvmat", header: "Extra loading wages paid by driver(+)" },
...
export const getACK = () => {
  return [
    ...
    { field: "loadingcharges", header: "Loading Charges(+)" },
...
export const ackWidths = [50,'*',50,50,80,50,50,50,50,40,50,50,50,50,60,60,60,60]
...
export const getACK2 = () => {
  return [
    ...
    { field: "ats.trucknumber", header: "Truck Number" },
    { field: "ats.transname", header: "Transport Name" },
    { field: "ats.bytopay", header: "By To Pay(+)" },
    { field: "ats.lateday", header: "Late Delivery(+)" },
    { field: "ats.halting", header: "Halting(+)" },
    { field: "expense", header: "Unloading Wages(+)" },
    { field: "podcharge", header: "POD Charge(+)" },
...
export const ackWidths2 = [50,'*',50,50,50,50,40,40,50,50,40,50,50,50,50,50,50,50,50,50,50]
